...
def main():
    ...
    dob = st.date_input("Enter your birth date:", min_value=datetime.date(1900, 1, 1), max_value=datetime.date(2200, 12, 31))
...
if __name__ == "__main__":
    st.sidebar.text("Made by: sai sarath pagadala")
